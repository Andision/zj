...
var page_actions = function(){
	...
	//计算logo宽度
	/*var logoW = $(".hn-logo-02").width() + 20;
	var headerW = $(window).width();
	var logoWidth = function(a){
		headerW = $(window).width();
		var menuW = headerW - logoW;
		$(".hn-logo-02").width(logoW);
		$(".big-menu").width(menuW);
	};
	if(headerW >= 1023){
		logoWidth();
	}else{
...
//    });        
   ...
   /* $(".h-navigation-header .nav-menu.nav-menu-theme > a").on("click",function(e){
        if($(this).parent("div.nav-menu").hasClass("active")){
        	$(this).parent("div.nav-menu").removeClass("active");
        	$(this).parent("div.nav-menu").removeClass("bg-act");
        }else{
        	$("div.nav-menu.nav-menu-user").removeClass("active"); 
        	$("div.nav-menu.nav-menu-msn").removeClass("active");
        	$("div.nav-menu.nav-menu-user").removeClass("bg-act"); 
        	$("div.nav-menu.nav-menu-msn").removeClass("bg-act");
        	$(this).parent("div.nav-menu").addClass("active"); 
        	$(this).parent("div.nav-menu").addClass("bg-act");
        }
    });*/
...
//ren.jq
//    $(".close-menu-01").click(function(){
//        $(this).parents(".x-navigation").toggleClass("menu-01-close");
//        
//        onresize();        
//        return false;
//    });
//	$(".close-menu-02").click(function(){
//        $(this).parents(".x-navigation").toggleClass("menu-02-close");
//        
//        onresize();        
//        return false;
//    });
//	$(".close-menu-03").click(function(){
//        $(this).parents(".x-navigation").toggleClass("menu-03-close");
//        
//        onresize();        
//        return false;
//    });
//	$(".close-menu-04").click(function(){
//        $(this).parents(".x-navigation").toggleClass("menu-04-close");
//        
//        onresize();        
//        return false;
//    });
//	$(".close-menu-05").click(function(){
//        $(this).parents(".x-navigation").toggleClass("menu-05-close");
//        
//        onresize();        
//        return false;
//    });
...
//$(".swiper-note .close").on("click",function(){
...
//日程-日期选择-Ren.jq-END
//$("body").delegate(".calendar-box .calendar-more","click",function(e){
//	if($(this).hasClass("active")){
//		$(".calendar-list").removeClass("hidden-list");
//		$(".calendar-more").html("收起 <i class='fa fa-angle-up'></i>");
//		//$(".calendar-more .fa").toggleClass("fa-angle-up");
//	//	$(".calendar-more .fa").toggleClass("fa-angle-down");
//		$(this).removeClass("active");
//		$('#brand-waterfall').cascade();
//    }else{
//        $(".calendar-list").addClass("hidden-list");
//        $(".calendar-more").html("展开全部6个日程 <i class='fa fa-angle-down'></i>");
//     //   $(".calendar-more .fa").toggleClass("fa-angle-up");
//      //  $(".calendar-more .fa").toggleClass("fa-angle-down");
//        $(this).addClass("active"); 
//        $('#brand-waterfall').cascade();
...
var dropdownH = optmun*37;
var top = $(selectDp).offset().top;
var left = $(selectDp).offset().left;
var bodyH = $('body').height();
var dropmaxH = $(".dropdown-menu.open").css("max-height");
var dropminH = $(".dropdown-menu.open").css("min-height");
var reg = new RegExp("px","g");
var dropmaxHValue = dropmaxH.replace(reg, "");
var dropminHValue = dropminH.replace(reg, "");
if(dropdownH > dropmaxHValue){
if(top > (bodyH - top - 30)){
	if(dropmaxHValue > top){
		selectH = top - 20;
	}else{
		var selectH = dropmaxHValue;
	}
}else{
	if(dropmaxHValue > (bodyH - top - 50)){
		selectH = (bodyH - top - 50);
	}else{
		var selectH = dropmaxHValue;
	}
}
...
if(top > (bodyH - top - 30)){
	if(dropdownH > top){
		...
		var selectH = dropdownH + 1;
	}
}else{
	if(dropdownH > (bodyH - top - 50)){
		selectH = (bodyH - top - 50);
	}else{
		var selectH = dropdownH + 1;
	}
...
$(".select-dropdown-fixed .dropdown-menu.open").css("height",selectH);
...
if((bodyH - top - 30) > top ){
$(".select-dropdown-fixed .dropdown-menu.open").css("top",top + 30);
$(".select-dropdown-fixed .dropdown-menu.open").css("left",left);
$(".select-dropdown-fixed .dropdown-menu.open").css("position","fixed");
}else{
$(".select-dropdown-fixed .dropdown-menu.open").css("top",top - selectH -20);
$(".select-dropdown-fixed .dropdown-menu.open").css("left",left);
$(".select-dropdown-fixed .dropdown-menu.open").css("position","fixed");
}
};
